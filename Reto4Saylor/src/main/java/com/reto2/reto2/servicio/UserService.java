...
import com.reto2.reto2.repositorio.UserRepository;
...
public class UserService {
    ...
    public List<User> getByMonthBirthDay(String monthBirthtDay){
        return userRepository.getByMonthBirthDhay(monthBirthtDay);
    }
}
